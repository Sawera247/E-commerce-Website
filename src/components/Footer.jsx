    ...
    <footer className="bg-black text-white">
      <div className="flex flex-col sm:flex-row justify-evenly py-8 gap-8 sm:gap-0 w-11/12 mx-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/signup" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Login / Register
          </Link>
          <Link to="/cart" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Cart
          </Link>
          <Link to="/shop" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Shop
          </Link>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/about" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Privacy Policy
          </Link>
          <Link to="/about" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Terms Of Use
          ...
          <Link to="/contact" className="font-light text-sm text-[#8d8d8d] hover:underline">
            Contact
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center py-4 w-11/12 mx-auto gap-4 sm:gap-0 text-[#262626]">
        ...
        <div className="flex gap-4 text-lg justify-center sm:justify-end">
          <a href="https://www.facebook.com/saira.fayyaz.754" target="_blank"><FaFacebookF className="hover:text-blue-600 cursor-pointer" /></a>
          <a href="https://github.com/Sawera247" target="_blank"><FaGithub className="hover:text-gray-800 cursor-pointer" /></a>
          <a href="https://www.instagram.com/sawera_fayyaz/" target="_blank"><FaInstagram className="hover:text-pink-500 cursor-pointer" /></a>
          <a href="https://www.linkedin.com/in/sawera-fayyaz-a57b16372/" target="_blank"><FaLinkedinIn className="hover:text-blue-700 cursor-pointer" /></a>
        </div>
      </div>
    </footer>
  );
